"""
This will recalculate the points for each user and upload the new total score to
the user totals as score2. This is helpful to ensure consistency in calculations
...
class Calculator:
    ...
    def single(self, entry):
        ...
        points = points + self.food_points(
            entry["veggies"], self.user["goal_veggies"], True
        )
